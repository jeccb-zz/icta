...
config :icta, Icta.Repo,
  ...
  username: System.get_env("ICTA_DATABASE_USERNAME"),
  password: System.get_env("ICTA_DATABASE_PASSWORD"),
  database: System.get_env("ICTA_DATABASE_NAME"),
  hostname: System.get_env("ICTA_DATABASE_HOST"),
  pool_size: 20
